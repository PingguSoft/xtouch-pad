...
lv_obj_t *ui_download_popupscreen_init(lv_obj_t *comp_parent) {
    ...
    lv_obj_set_height(ui_container, lv_pct(35));
    lv_obj_set_x(ui_container, -2);
    ...
    lv_obj_set_flex_align(ui_container, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    ...
    lv_obj_set_style_pad_top(ui_container, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_container, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_row(ui_container, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_popup_title, "Sync with Printer");
    ...
    lv_obj_set_style_pad_top(ui_filename, 15, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_filename, 15, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_filename, LV_OBJ_FLAG_HIDDEN);

    ui_progress = lv_bar_create(ui_container);
    lv_bar_set_value(ui_progress, 0, LV_ANIM_OFF);
    lv_bar_set_start_value(ui_progress, 0, LV_ANIM_OFF);
    lv_obj_set_width(ui_progress, lv_pct(100));
    ...
    lv_obj_set_style_pad_top(ui_progress, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_progress, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
